...
from algorithms.ucb_TT import TTUCB
from algorithms.adap_TT import AdaPTopTwo
...
def run_simulation(config): 
    """ runs a bandit algorithm with the hyperparameters specified in config. This function is passed later to workers from the multiprocessing.Pool module.
...
if __name__ == "__main__":
    ...
    #choose a mean for the bandit instance
    ...
    #Read results from .csv file and plot
    subfolders = ["/UCBTT", "/AdaPTT","/DPSE" ] 
    data = []
    names = []
    fig, ax = plt.subplots()
